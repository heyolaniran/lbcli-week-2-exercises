...
CHANGE_AMOUNT=$(echo $AMOUNT - $SEND_AMOUNT| bc)




RAW_CREATED=$(bitcoin-cli -regtest createrawtransaction "[{\"txid\":\"$TXID\" ,\"vout\":$VOUT_1},{\"txid\":\"$TXID\", \"vout\":$VOUT_2}]" "{\"$RECIPIENT\":\"0.20000000\", \"$CHANGE_ADDRESS\":\"0$CHANGE_AMOUNT\"}")
